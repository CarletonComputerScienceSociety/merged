...
const ORGANIZATIONS: Organization[] = [
  {
    ...
    backgroundUrl: 'https://ccss.carleton.ca/ccss-website/images/slideshow/orientation.jpeg'
  },
  {
    id: 2,
    title: 'CuHacking',
  ...
  {
    id: 8,
    title: 'Carleton Web Development Club',
    description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
  ...
  {
    id: 11,
    title: 'Carleton Cyber Security Club',
    description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
