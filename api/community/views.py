...
class EventListAll(generics.GenericAPIView): #List all job events, or create a new  event
...
class OrganizationListByTitle(generics.GenericAPIView): #List of Organizations by Title/Name
